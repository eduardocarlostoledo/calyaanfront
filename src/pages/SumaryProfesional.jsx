...
<div>
  ...
  //   // <div className="container mx-auto p-2 sm:p-4 flex gap-1 sm:gap-4 3xl:gap-8 bg-white flex-wrap items-center justify-center">
  //   //   <div className="bg-white rounded shadow-lg p-4 md:p-8 mb-6 w-full lg:w-4/5">
  //   <div className="container mx-auto p-2 sm:p-4 flex flex-wrap items-center justify-center">
  //     <div className="bg-white rounded shadow-lg p-4 md:p-8 mb-6 w-full lg:w-4/5 sm:mb-12 md:mb-8">

  //       {/* <div className="mx-auto p-2 md:p-4 flex gap-4 3xl:gap-8 bg-whitefull-screen flex-wrap items-center justify-center"> */}
  //       <div className="mx-auto p-2 md:p-4 sm:my-0 flex gap-4 3xl:gap-8 bg-white full-screen flex-wrap items-center justify-center">

  //         {/* <p className="text-2xl md:text-4xl text-center font-semibold leading-9 text-gray-800"> */}
  //             <p className="text-xl sm:text-sm md:text-4xl text-center font-semibold leading-6 sm:leading-4 text-gray-800 my-1 sm:my-0">
  //               ¡Contamos contigo para brindar el mejor servicio!
  //             </p>
  //           <div className="mx-auto">
  //             <div className="mt-1">
  //               <p className="text-base sm:text-sm md:text-xl text-gray-800 leading-tight font-medium text-center sm:text-left">
  //                 Número de orden:{" "}
  //                 <span className="text-gray-600 font-normal sm:text-center block sm:inline">
  //                   {historial._id}
  //                 </span>
  //               </p>
  //               <p className="text-base md:text-xl text-gray-800 leading-tight font-medium mt-1 sm:mt-6 text-center sm:text-left">
  //                 Día y Hora:{" "}
  //                 <span className="text-gray-600 font-normal sm:text-center block sm:inline">
  //                   {historial?.cita_servicio} - {historial?.hora_servicio}
  //                 </span>
  ...
  //                 Cliente: {" "}
  //                 <span className="text-gray-600 font-normal sm:text-center block sm:inline">
  //                   {historial?.cliente_id?.nombre || "Pendiente"}      </span>
  //               </p>
  ...
  //                       <p className="text-base leading-none text-gray-600 py-1">
  //                         {servicio?.nombre}
  //                       </p>
  //                       <p className="text-base font-semibold leading-none text-gray-800 mt-4">
  //                         <NumericFormat
