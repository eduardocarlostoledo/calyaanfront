          ...
          <div className="flex sm:flex-row flex-col">
            <div className="flex flex-row mb-1 sm:mb-0">
              ...
              <div className="relative">
                ...
                >
                  <option className="todos">Todos</option>
                  <option className="activo">Activo</option>
                  <option className="suspendido">Suspendido</option>
                </select>
                <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700">
                  <MdKeyboardArrowDown className="fill-current h-4 w-4" />
                </div>
          ...
          <div className="inline-block min-w-full shadow rounded-lg overflow-hidden">
            <table className="min-w-full leading-normal">
              ...
              <tbody>
                {loading ? (
                ...
                ) : paginado?.resultadoFilter?.length <= 0 ? (
                  <tr>
                    <td></td>
                    <td></td>
                    <td className="h-48 flex items-center">
                  ...
                  paginado?.resultadoFilter?.map((user) => (
                    <tr key={user._id}>
