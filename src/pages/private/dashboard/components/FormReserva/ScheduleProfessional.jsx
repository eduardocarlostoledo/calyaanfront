...
const ScheduleProfessional = ({ nombreServicio, localidadServicio, reserva, setReserva, id }) => {
  ...
  const handleSubmitProfessional = async () => {
    ...
    try {
      let { data } = await clienteAxios.post("api/pay/finish/agendar", { id, profesional_id: profesional.creador._id, cita_servicio: inputValue.date, hora_servicio: inputValue.time });
