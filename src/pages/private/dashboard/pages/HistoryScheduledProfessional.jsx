    ...
    <div className="bg-white dark:bg-gray-800 shadow rounded xl:flex lg:flex w-full">
      <div className="xl:w-2/5 lg:w-2/5 bg-white dark:bg-gray-800 py-8 border-gray-300 dark:border-gray-200 xl:border-r rounded-tl xl:rounded-bl rounded-tr xl:rounded-tr-none lg:border-r-2 border-b xl:border-b-0 flex justify-center items-center">
        <div className="flex flex-col items-center">
          ...
          <button className="bg-whatsapp font-medium transition duration-150 ease-in-out  rounded text-white px-6 py-2 text-sm border border-gray-300 dark:border-gray-200 focus:outline-none">
            Enviar mensaje
          </button>
          <Link
            to={`/dashboard/perfil-profesional/${id}`}
            className="bg-white font-medium transition duration-150 ease-in-out mt-2 hover:bg-gray-200 rounded text-gray-800 px-6 py-2 text-sm border border-gray-300 dark:border-gray-200 focus:outline-none"
          >
            Volver a perfil
          </Link>
        </div>
