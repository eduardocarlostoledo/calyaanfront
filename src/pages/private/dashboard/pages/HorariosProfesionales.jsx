...
// const DisponibilidadTotalComponent = () => {
//   const [disponibilidadTotal, setDisponibilidadTotal] = useState([]);
//   const [loading, setLoading] = useState(true);
...
//           "http://localhost:3001/api/profesional/disponibilidades-totales"
//         );
//         console.log(response);
//         setDisponibilidadTotal(response.data);
//         setLoading(false);
//       } catch (error) {
//         console.log(error);
//       }
...
//   return (
//     <div>
//       {disponibilidadTotal.length > 0 ? (
//         disponibilidadTotal.map((disponibilidad) => (
//           <div key={disponibilidad._id}>
//             {disponibilidad._id}
//             <p> ----------------------------------</p>
//             {/* <p>
//               {disponibilidad.creador.creador.apellido}{" "}
//               {disponibilidad.creador.creador.nombre}
//             </p> */}
//           </div>
//         ))
//       ) : (
//         <div>No se encontraron profesionales disponibles</div>
//       )}
//     </div>
//   );
// };

// export default DisponibilidadTotalComponent;
