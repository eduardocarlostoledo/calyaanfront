...
const FormUpdateProfile = () => {
  ...
  const { especialidad, descripcion, localidadesLaborales } = valueForm;
  ...
  useEffect(() => {
    const getProfile = async () => {
      try {
        ...
        const { descripcion, especialidad, localidadesLaborales } =
          data.profesional;
  ...
  const handleChangeLocalidad = (e) => {
    ...
    setValueForm({ ...valueForm, localidadesLaborales: e.target.value });
  };
  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit} className="mt-2">
        ...
        <label htmlFor="localidadesLaborales">Zonas Laborales</label>
        <div className="mt-2 mb-4">
          <select
            id="localidadesLaborales"
            className="border border-gray-300 text-gray-900 text-sm rounded-lg bg-gray-200 focus:border-bgHover focus:bg-white focus:outline-none block w-full p-3"
            value={localidadesLaborales}
            onChange={handleChangeLocalidad}
            name="localidadesLaborales"
          >
