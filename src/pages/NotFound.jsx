    ...
    <section className="bg-white">
      <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 h-screen flex justify-center items-center">
        <div className="mx-auto max-w-screen-sm text-center">
          ...
          <Link  to="/servicios" className="inline-flex text-white bg-primary hover:bg-bgHover focus:ring-4 focus:outline-none focus:ring-primary font-medium rounded-lg text-sm px-5 py-2.5 text-center my-4">Volver a la página de inicio</Link>
        </div>
      </div>
    </section>
  )
